...
ALTER TABLE `player` ADD `eliminated_by` varchar(30) NOT NULL DEFAULT '0';
...
CREATE TABLE IF NOT EXISTS `integrityCards` (
  ...
  `has_bomb_symbol` INT UNSIGNED NOT NULL DEFAULT 0,
  `has_knife_symbol` INT UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`card_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
